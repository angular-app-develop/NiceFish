...
class XI18nWebpackConfig extends webpack_config_1.NgCliWebpackConfig {
    ...
    buildConfig() {
        ...
        const extractI18nConfig = webpack_configs_1.getWebpackExtractI18nConfig(projectRoot, this.appConfig, this.extractOptions.genDir, this.extractOptions.i18nFormat);
